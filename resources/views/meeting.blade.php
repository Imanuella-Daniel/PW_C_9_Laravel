...
<main class="container">
    <div id="roomCarousel" class="carousel slide room-images" data-bs-ride="carousel">
        <div class="carousel-inner">
            @foreach ($roomMeet['images'] as $index => $image)
    ...
    <div class="room-info">
        ...
        <div class="booking-card">
            <div style="display: flex; align-items: center;">
                <div class="price">{{ $roomMeet['price'] }}</div>
                <p class="mb-4" style="margin: 1px;">/ 12 hours</p>
            </div>
            <a href="#" class="btn btn-pink w-100">Book Now</a>
        </div>
    </div>
</main>
<footer class="footer">

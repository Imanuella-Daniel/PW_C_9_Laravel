                    ...
                    <div class="col-md-12 mb-4">
                        <div class="room-card d-flex justify-content-between align-items-center p-3 shadow">
                            ...
                            <div class="room-info">
                                ...
                                <p class="mb-0">
                                    {{ strlen($room->Desc) > 200 ? substr($room->Desc, 0, 200) . '...' : $room->Desc }}
                                </p>

                                <a href="{{ route('room.detail', $room->NoKamar) }}"
                                    class="btn btn-pink text-white">See availability</a>
                            </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div
                            ...
                            <span class="badge badge-success position-absolute"
                                style="top: 10px; left: 10px;">{{ $facility->discount_percentage }}50% off</span>
                            <img src="{{ asset('/' . $facility->Gambar) }}" alt="{{ $facility->NamaFasilitas }}"
                                class="img-fluid">
                            <div class="room-info">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <span class="ml-2">{{ $facility->Rating }} ({{ $facility->reviews }}
                                        Reviews)</span>
                                </div>
                                <div class="room-details">
                                ...
                                <a href="{{ route('facility_details', $facility->IDFasilitas) }}"
                                    class="btn btn-pink text-white">See availability</a>
                            </div>
                            <div class="room-price text-right">
                                <h4 class="small-red" style="font-size: 12px; color: red;"><del>Rp.
                                        {{ number_format($facility->Biaya * 2, 0, ',', '.') }}</del></h4>

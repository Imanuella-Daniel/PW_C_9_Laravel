...
<head>
    ...
    <title>Hahahihi Hotel - Home</title>
...
<div class="navbar-container">
        ...
        <div class="banner-content">
            ...
            <div class="intro-text">
                <div class="grouped-text">
                    <p>Hahahihi Hotel is an oasis of tranquility amidst the hustle and bustle of the city, offering an elegant and classy stay experience. With its minimalist modern design,</p>
                    <p>we create the perfect atmosphere for travelers who appreciate simplicity and beauty.</p>
                </div>
                <p></p>
                <div class="grouped-text">
                    <p></p>
                    <p>Strategically located in the heart of the city, Hahahihi Hotel provides easy access to shopping centers, dining spots, and nightlife, just minutes away from the airport.</p>
                </div>
                <p></p>
                <div class="grouped-text">
                    <p>Every detail at Hahahihi Hotel is thoughtfully designed to blend modern aesthetics with unparalleled comfort. Enjoy spacious rooms equipped with the latest
                    <p>amenities, along with exceptional service that caters to your every need.</p>
                </div>
                <p></p>
                <div class="grouped-text">
                    <p>More than just a place to stay, Hahahihi Hotel offers an experience that combines modern simplicity with warm comfort. Discover beauty in simplicity and enjoy</p>
        ...
        <p>Discover the perfect space for you!</p>
            <div class="room-check-form">
                <form action="{{ url('/available_room') }}" method="GET" style="display: flex; align-items: center; justify-content: flex-start; gap: 12px;">
                    ...
                    <div>
                        <label for="person" style="display: block; font-size: 13px; color: #9A9A9A; text-align: left; margin-bottom: 5px;">Person</label>
                        <select id="person" name="person" style="width: 180px; height: 40px; border-radius: 10px; border: 1px solid #ccc;">
                    ...
                    <div>
                        <button type="submit" class="check-room-btn" style="width: 180px; height: 40px; border-radius: 10px;">Check Room</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="special-offers">
        ...
        <div class="offers-container">
            ...
            <div class="offer-card">
                <img src="{{ asset('img/dining.jpg') }}" alt="Romantic Dining" style="width: 100%; border-radius: 10px;">               
                <h5>Room</h5>

...
<body>
    <div class="navbar-container">
        <nav class="navbar">
            ...
            <a href="{{ route('home_page') }}" class="navbar-logo-container"><img src="{{ asset('img/BLUE.png') }}"
                    alt="Blue Haven Hotel Logo" class="navbar-logo"></a>
    ...
    <div class="container-fluid py-5">
        <div class="container mt-4">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card mb-4">
                        <h4 class="card-header text-left fw-bold"> <i class="fa-solid fa-shield"></i> Customer Profile
                        </h4>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="firstName"
                                            placeholder="Enter First name" value="{{ Auth::user()->NamaDepan }}"
                                            required>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="lastName"
                                            placeholder="Enter Last name" value="{{ Auth::user()->NamaBelakang }}"
                                            required>
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" name="phone" type="text"
                                            value="{{ Auth::user()->NoTelepon }}" required />
                                    </div>
                                </div>
                        </div>
                    </div>
                    <div class="card mb-4">
                        <h4 class="card-header text-left fw-bold">
                            <span class="amenity-icon" aria-label="Door"> <i class="bi bi-door-open-fill"> </i></span>
                            Room Detail
                        </h4>
                        <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-8 d-flex align-items-center">
                                            @foreach (['BCA', 'Mandiri', 'BNI', 'BRI'] as $bank)
                                                <div class="me-3">
                                                    <button
                                                        class="btn btn-outline-secondary payment-btn d-flex flex-column align-items-center justify-content-center"
                                        ...
                                        <div class="col-4 d-flex align-items-center">
                                            ...
                                            <input type="tel" class="form-control" id="NoKartuBank"
                                                name="NoKartu" placeholder="Enter Card Number" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-4 d-flex align-items-center">
                                            ...
                                            <input type="tel" class="form-control" id="NoKartuPhone"
                                                name="NoKartu" placeholder="Enter Phone Number" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col text-end">
                                <span class="total-payment"
                                    id="modalPrice"><strong>{{ $roomDetails['formattedPrice'] }}</strong></span>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body transfer-instructions text-start">
                                        ...
                                        <p>3. Enter your PIN then select Send. If a confirmation message for
                                            transactions
